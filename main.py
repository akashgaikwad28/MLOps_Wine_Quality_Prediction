...
from src.Wine_Quality_Prediction.pipeline.model_trainer_pipeline import ModelTrainerTrainingPipeline
...
try:
    ...
    data_ingestion.initiate_data_ingestion()  # <-- Call the method
